...
"""
Define Turtlebot 2 Flex Planner Detector Two.
...
class Turtlebot2FlexPlannerDetectorTwoSM(Behavior):
    """
    Define Turtlebot 2 Flex Planner Detector Two.
    ...
    def __init__(self, node):
        super().__init__()
        self.name = 'Turtlebot 2 Flex Planner Detector Two'
    ...
    def create(self):
        ...
        with _sm_container_0:
            ...
            OperatableStateMachine.add('ball_detector',
                                       ...
                                       transitions={'unavailable': 'failed', 'invalid': 'failed',
                                                    'red_ball': 'red_ball', 'green_ball': 'other_ball',
                                                    'blue_ball': 'other_ball'},
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('Container',
                                       _sm_container_0,
                                       transitions={'finished': 'Log Success', 'failed': 'Continue',
                                                    'red_ball': 'saw_red', 'other_ball': 'saw_other_ball'},
