...
@author: Josh Zutell
'''
class Turtlebot2MultiLevelFlexPlannerSM(Behavior):
	'''
	Uses Flexible Navigation to control the Turtlebot 2 robot with 3-level planning.
		high-level: Map only
	...
	def __init__(self, node):
		super(Turtlebot2MultiLevelFlexPlannerSM, self).__init__()
		self.name = 'Turtlebot 2 Multi-Level Flex Planner'
